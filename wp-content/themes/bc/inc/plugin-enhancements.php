	...
	function get_theme_dependencies() {
		...
		if ( current_theme_supports( 'jetpack-content-options' ) ) :
			$dependencies['content-options'] = array(
				'name' => esc_html__( 'Content Options', 'pique' ),
...
function pique_enqueue_scripts() {
...
add_action( 'admin_enqueue_scripts', 'pique_enqueue_scripts' );
 ...
 */
function pique_dismiss_admin_notice() {
...
add_action( 'wp_ajax_pique_jetpack_admin_notice', 'pique_dismiss_admin_notice' );
